...
void main() {
  group('EnquiryFormScreen Widget Tests', () {
    ...
    group('Role-Based Visibility', () {
      testWidgets('should show admin-only fields for admin users', (WidgetTester tester) async {
        // Test admin field visibility
        expect(true, isTrue); // Placeholder test
      });

      testWidgets('should hide admin-only fields for staff users', (WidgetTester tester) async {
