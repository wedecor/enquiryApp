...
import 'package:we_decor_enquiries/core/services/session_service.dart';
...
void main() {
  group('SessionService Tests', () {
    ...
    test('disabled user: profile with isActive false is not active', () {
      expect(
        isProfileActive({
          'name': 'Disabled User',
    ...
    test('disabled user: profile with active false is not active', () {
      expect(
        isProfileActive({
          'name': 'Disabled User',
          'email': 'disabled@example.com',
    ...
    test('active user: missing isActive defaults to active', () {
      expect(
        isProfileActive({'name': 'Active User', 'email': 'active@example.com', 'role': 'staff'}),
        isTrue,
      );
    });
