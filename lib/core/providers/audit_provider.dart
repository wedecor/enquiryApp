...
final enquiryHistoryProvider =
    StreamProvider.family<List<Map<String, dynamic>>, String>((ref, enquiryId) {
...
final fieldHistoryProvider =
    StreamProvider.family<List<Map<String, dynamic>>, Map<String, String>>((
      ...
      return Stream.fromFuture(
        auditService.getFieldHistory(enquiryId, fieldName),
      );
    });
...
final enquiryChangeSummaryProvider =
    StreamProvider.family<Map<String, dynamic>, String>((ref, enquiryId) {
      final auditService = ref.read(auditServiceProvider);
