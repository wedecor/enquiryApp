...
_$UserSettingsImpl _$$UserSettingsImplFromJson(Map<String, dynamic> json) => _$UserSettingsImpl(
  ...
  dashboard: json['dashboard'] == null
      ...
      : DashboardSettings.fromJson(json['dashboard'] as Map<String, dynamic>),
...
_$DashboardSettingsImpl _$$DashboardSettingsImplFromJson(Map<String, dynamic> json) =>
    _$DashboardSettingsImpl(
      dateRange: json['dateRange'] as String? ?? '30d',
      statusTabs:
          (json['statusTabs'] as List<dynamic>?)?.map((e) => e as String).toList() ??
...
Map<String, dynamic> _$$DashboardSettingsImplToJson(_$DashboardSettingsImpl instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$$ColumnSettingsImplToJson(_$ColumnSettingsImpl instance) =>
    <String, dynamic>{'id': instance.id, 'visible': instance.visible, 'order': instance.order};

_$NotificationSettingsImpl _$$NotificationSettingsImplFromJson(Map<String, dynamic> json) =>
    _$NotificationSettingsImpl(
      pushEnabled: json['pushEnabled'] as bool? ?? true,
      emailEnabled: json['emailEnabled'] as bool? ?? false,
      channels: json['channels'] == null
          ? const NotificationChannels()
          : NotificationChannels.fromJson(json['channels'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$NotificationSettingsImplToJson(_$NotificationSettingsImpl instance) =>
    <String, dynamic>{
...
_$NotificationChannelsImpl _$$NotificationChannelsImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$NotificationChannelsImplToJson(_$NotificationChannelsImpl instance) =>
    <String, dynamic>{
