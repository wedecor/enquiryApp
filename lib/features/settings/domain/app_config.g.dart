...
_$AppGeneralConfigImpl _$$AppGeneralConfigImplFromJson(
...
Map<String, dynamic> _$$AppGeneralConfigImplToJson(
        _$AppGeneralConfigImpl instance) =>
    <String, dynamic>{
...
_$AppNotificationConfigImpl _$$AppNotificationConfigImplFromJson(
        Map<String, dynamic> json) =>
    _$AppNotificationConfigImpl(
      emailInvitesEnabled: json['emailInvitesEnabled'] as bool? ?? true,
      replyToEmail:
          json['replyToEmail'] as String? ?? 'connect2wedecor@gmail.com',
...
Map<String, dynamic> _$$AppNotificationConfigImplToJson(
        _$AppNotificationConfigImpl instance) =>
    <String, dynamic>{
...
_$AppSecurityConfigImpl _$$AppSecurityConfigImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$AppSecurityConfigImplToJson(
        _$AppSecurityConfigImpl instance) =>
    <String, dynamic>{
