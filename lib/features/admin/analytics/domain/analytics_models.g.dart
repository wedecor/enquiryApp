...
_$DateRangeImpl _$$DateRangeImplFromJson(Map<String, dynamic> json) => _$DateRangeImpl(
  start: DateTime.parse(json['start'] as String),
  end: DateTime.parse(json['end'] as String),
);

Map<String, dynamic> _$$DateRangeImplToJson(_$DateRangeImpl instance) => <String, dynamic>{
  'start': instance.start.toIso8601String(),
  'end': instance.end.toIso8601String(),
};

_$KpiSummaryImpl _$$KpiSummaryImplFromJson(Map<String, dynamic> json) => _$KpiSummaryImpl(
...
Map<String, dynamic> _$$KpiSummaryImplToJson(_$KpiSummaryImpl instance) => <String, dynamic>{
...
_$KpiDeltasImpl _$$KpiDeltasImplFromJson(Map<String, dynamic> json) => _$KpiDeltasImpl(
  ...
  estimatedRevenueChange: (json['estimatedRevenueChange'] as num).toDouble(),
);

Map<String, dynamic> _$$KpiDeltasImplToJson(_$KpiDeltasImpl instance) => <String, dynamic>{
...
_$SeriesPointImpl _$$SeriesPointImplFromJson(Map<String, dynamic> json) => _$SeriesPointImpl(
  x: DateTime.parse(json['x'] as String),
  count: (json['count'] as num).toInt(),
);

Map<String, dynamic> _$$SeriesPointImplToJson(_$SeriesPointImpl instance) => <String, dynamic>{
  'x': instance.x.toIso8601String(),
  'count': instance.count,
};

_$CategoryCountImpl _$$CategoryCountImplFromJson(Map<String, dynamic> json) => _$CategoryCountImpl(
...
Map<String, dynamic> _$$CategoryCountImplToJson(_$CategoryCountImpl instance) => <String, dynamic>{
  'key': instance.key,
  'count': instance.count,
...
_$RecentEnquiryImpl _$$RecentEnquiryImplFromJson(Map<String, dynamic> json) => _$RecentEnquiryImpl(
...
Map<String, dynamic> _$$RecentEnquiryImplToJson(_$RecentEnquiryImpl instance) => <String, dynamic>{
  'id': instance.id,
...
_$AnalyticsFiltersImpl _$$AnalyticsFiltersImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$AnalyticsFiltersImplToJson(_$AnalyticsFiltersImpl instance) =>
    <String, dynamic>{
...
_$AnalyticsStateImpl _$$AnalyticsStateImplFromJson(Map<String, dynamic> json) =>
    _$AnalyticsStateImpl(
      filters: AnalyticsFilters.fromJson(json['filters'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$AnalyticsStateImplToJson(_$AnalyticsStateImpl instance) =>
    <String, dynamic>{
