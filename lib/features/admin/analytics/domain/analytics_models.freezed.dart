...
mixin _$KpiDeltas {
  ...
  /// Serializes this KpiDeltas to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of KpiDeltas
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
...
abstract class $CategoryCountCopyWith<$Res> {
  ...
  @useResult
  $Res call({String key, int count, double percentage});
}
...
class _$CategoryCountImpl implements _CategoryCount {
  ...
  @override
  String toString() {
    return 'CategoryCount(key: $key, count: $count, percentage: $percentage)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, key, count, percentage);
...
mixin _$RecentEnquiry {
  ...
  /// Serializes this RecentEnquiry to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RecentEnquiry
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
...
mixin _$AnalyticsFilters {
  ...
  /// Serializes this AnalyticsFilters to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
