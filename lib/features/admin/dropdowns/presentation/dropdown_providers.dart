...
final dropdownGroupProvider = StateNotifierProvider<DropdownGroupState, DropdownGroup>((ref) {
...
final dropdownQueryProvider = StateNotifierProvider<DropdownQueryState, String>((ref) {
