...
Future<void> _createPaymentStatusesCollection(FirebaseFirestore firestore) async {
  ...
  final paymentStatusesRef = firestore.collection('dropdowns').doc('payment_statuses').collection('items');
...
Future<void> _createBudgetRangesCollection(FirebaseFirestore firestore) async {
  ...
  final budgetRangesRef = firestore.collection('dropdowns').doc('budget_ranges').collection('items');
